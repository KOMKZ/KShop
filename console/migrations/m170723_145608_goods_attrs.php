...
class m170723_145608_goods_attrs extends Migration
{
    ...
    public function safeUp(){
        ...
        create table `{$tableName}`(
            ...
            `g_atr_type` char(10) not null comment '商品属性分类',
            `g_atr_opt_img` smallint(3) unsigned not null default 0 comment '商品属性选项是否能有图片',
        ...
        $this->batchInsert($this->getTableName(), [
            ...
            ['g_atr_id' => 1, 'g_atr_cls_type' => 'cls', 'g_atr_opt_img' => 0, 'g_atr_code' => 'model_number', 'g_atr_type' => 'meta', 'g_atr_name' => '型号', 'g_atr_show_name' => '型号', 'g_atr_cls_id' => 1, 'g_atr_created_at' => time()],
