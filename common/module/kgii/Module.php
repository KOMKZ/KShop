 ...
 *     'bootstrap' => ['gii'],
 *     'modules' => [
 *         'gii' => ['class' => 'common\module\kgii\Module'],
 *     ],
 * ]
 * ~~~
 *
...
class Module extends \yii\base\Module implements BootstrapInterface
{
     ...
     * @inheritdoc
     */
    public $controllerNamespace = 'common\module\kgii\controllers';
    /**
    ...
    public function bootstrap($app)
    {
        if ($app instanceof \yii\web\Application) {
            ...
            $app->controllerMap[$this->id] = [
                'class' => 'common\module\kgii\console\GenerateController',
    ...
    {
        return [
            'model' => ['class' => 'common\module\kgii\generators\model\Generator'],
            'crud' => ['class' => 'common\module\kgii\generators\crud\Generator'],
            'controller' => ['class' => 'common\module\kgii\generators\controller\Generator'],
            'form' => ['class' => 'common\module\kgii\generators\form\Generator'],
            'module' => ['class' => 'common\module\kgii\generators\module\Generator'],
            'extension' => ['class' => 'common\module\kgii\generators\extension\Generator'],
        ];
    }
}
